...
public class Check {
    //通用版
    public static final String POST_URL_G_B = "https://aip.baidubce.com/rest/2.0/ocr/v1/general_basic?access_token=" + AuthService.getAuth();
    //通用含位置版
    public static final String POST_URL_G = "https://aip.baidubce.com/rest/2.0/ocr/v1/general?access_token=" + AuthService.getAuth();
    //高精度版
    public static final String POST_URL_A_B = "https://aip.baidubce.com/rest/2.0/ocr/v1/accurate_basic?access_token=" + AuthService.getAuth();
    //高精度含位置版
    public static final String POST_URL_A = "https://aip.baidubce.com/rest/2.0/ocr/v1/accurate?access_token=" + AuthService.getAuth();
    ...
    public static String post(String param) throws URISyntaxException, IOException {
        return post(POST_URL_G_B, param);
    }
     ...
     * @throws IOException        IO流异常
     */
    public static String post(String postURL, String param) throws URISyntaxException, IOException {
        //开始搭建post请求
    ...
    public static void main(String[] args) {
        String path = "C:\\Users\\haoge\\Desktop\\test333.png";
        try {
