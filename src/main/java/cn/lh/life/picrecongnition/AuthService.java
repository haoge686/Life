...
public class AuthService {
    ...
    // 官网获取的 API Key , 注册时提供
    private static final String CLIENT_ID = "uMNRu9tx2df2DaxELHB7ci7D";
    // 官网获取的 Secret Key , 注册时提供
    private static final String CLIENT_SECRET = "NnPEwxtAmC0plKiVuFMKvqg15kjgGtMi";
    // 获取token地址
