CREATE DATABASE `nts` DEFAULT CHARACTER SET utf8 DEFAULT COLLATE = utf8_general_ci;
...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          'JeeThink',   0, 'JeeThink', '18810991088', 'jt@qq.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'jt', '2018-03-16 11-33-00');
insert into sys_dept values(101,  100, '0,100',      '北京总公司', 1, 'JeeThink', '18810991088', 'jt@qq.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'jt', '2018-03-16 11-33-00');
insert into sys_dept values(102,  100, '0,100',      '上海分公司', 2, 'JeeThink', '18810991088', 'jt@qq.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'jt', '2018-03-16 11-33-00');
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', 'JeeThink', '00', 'jt@qq.com', '18810991088', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', 'jt', '2018-03-16 11-33-00', '管理员');
insert into sys_user values(2,  105, 'jt',    'JeeThink', '00', 'jt@qq.com',  '15666666666', '1', '', '8e6d98b90472783cc73c17047ddccf36', '222222', '0', '0', '127.0.0.1', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', 'jt', '2018-03-16 11-33-00', '测试员');
...
insert into sys_role values('2', '普通角色', 'common', 2, 2, '0', '0', 'admin', '2018-03-16 11-33-00', 'jt', '2018-03-16 11-33-00', '普通角色');
...
-- ----------------------------
-- 一级菜单
insert into sys_menu values('1', '系统管理', '0', '1', '#', '', 'M', '0', '', 'fa fa-gear',         'admin', '2018-03-16 11-33-00', 'jt', '2018-03-16 11-33-00', '系统管理目录');
insert into sys_menu values('2', '系统监控', '0', '2', '#', '', 'M', '0', '', 'fa fa-video-camera', 'admin', '2018-03-16 11-33-00', 'jt', '2018-03-16 11-33-00', '系统监控目录');
insert into sys_menu values('3', '系统工具', '0', '3', '#', '', 'M', '0', '', 'fa fa-bars',         'admin', '2018-03-16 11-33-00', 'jt', '2018-03-16 11-33-00', '系统工具目录');
-- 二级菜单
...
insert into sys_menu values('107',  '通知公告', '1', '8', '/system/notice',        '', 'C', '0', 'system:notice:view',       '#', 'admin', '2018-03-16 11-33-00', 'jt', '2018-03-16 11-33-00', '通知公告菜单');
...
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice values('1', '温馨提醒：2018-07-01 JeeThink新版本发布啦', '2', '新版本内容', '0', 'admin', '2018-03-16 11-33-00', 'jt', '2018-03-16 11-33-00', '管理员');
insert into sys_notice values('2', '维护通知：2018-07-01 JeeThink系统凌晨维护', '1', '维护内容',   '0', 'admin', '2018-03-16 11-33-00', 'jt', '2018-03-16 11-33-00', '管理员');
